...
const expenseListPaginateButtons = document.getElementById(
  "expenseListPaginateButtons"
);
...
function displayExpenseList(res) {
...
function paginateButtons(res) {
  expenseListPaginateButtons.innerHTML = "";
  ...
  if (hasPrevPage) {
    ...
    expenseListPaginateButtons.appendChild(buttonPrev);
  }
  const buttonCur = document.createElement("button");
  buttonCur.innerHTML = currentPage;
  buttonCur.classList.add("paginateButtonStyle");
  expenseListPaginateButtons.appendChild(buttonCur);
  if (hasNextPage) {
    const buttonNext = document.createElement("button");
    buttonNext.innerHTML = nextPage;
    buttonNext.classList.add("paginateButtonStyle");
    expenseListPaginateButtons.appendChild(buttonNext);
  }
}

//when you click on any paginated buttons
expenseListPaginateButtons.addEventListener("click", async (e) => {
