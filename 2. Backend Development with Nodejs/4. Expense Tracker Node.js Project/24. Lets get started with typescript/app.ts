...
const num1Element = document.getElementById("number1") as HTMLInputElement; //type-casting
const num2Element = document.getElementById("number2") as HTMLInputElement;
...
type NumOrString = number | string; //alias (other name)
...
buttonElement.addEventListener("click", () => {
  ...
  textArray.push(stringRes as string);
